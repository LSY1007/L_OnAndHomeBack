...
public interface ReviewRepository extends JpaRepository<Review, Long> {
    ...
    /**
     * 사용자 ID로 리뷰 목록 조회 (Product, Replies eager fetch)
     */
    @Query("SELECT DISTINCT r FROM Review r LEFT JOIN FETCH r.product LEFT JOIN FETCH r.replies WHERE r.user.id = :userId ORDER BY r.createdAt DESC")
